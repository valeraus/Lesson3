...
namespace Task2
{
    ...
    {
        public virtual void Study() { Console.WriteLine("Pupil.Stydy()"); }
    ...
    {
        public override void Study() {Console.WriteLine("ExcelentPupil.Stydy()");}
    ...
    {
        public override void Study() { Console.WriteLine("GoodPupil.Stydy()"); }
    ...
    {
        public override void Study() { Console.WriteLine("BadPupil.Stydy()"); }
